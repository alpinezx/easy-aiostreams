...
Want a system-wide VPN layer, phone alerts if your VPN tunnel drops or AIOStreams stops responding, or to turn a third-party site's webhook option into a phone alert? Those live in their own standalone scripts, see [Other Scripts](./docs/other-scripts.md)
